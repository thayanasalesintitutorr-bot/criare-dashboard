        ...
        <div className="rounded-3xl border border-white/60 bg-white/70 p-8 shadow-xl backdrop-blur-xl">
          <div className="mb-8 text-center">
            <motion.div
              ...
              className="mx-auto mb-4 inline-block rounded-full border border-[#2563EB]/20 bg-white/60 px-6 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-[#2563EB]"
            >
              Confirme seu dispositivo
            </motion.div>

            <h1 className="text-3xl font-black tracking-[-0.03em] text-[#2563EB] sm:text-4xl">
                ...
                <motion.button
                  ...
                  className={`relative flex flex-col items-center gap-3 rounded-2xl border-2 p-6 text-center transition ${
                    detectadoAqui
                      ...
                      : 'border-[#DBEAFE] bg-white/60 hover:border-[#2563EB]/40'
                  }`}
                >
                  {detectadoAqui && (
                    <span className="absolute -top-3 left-1/2 flex -translate-x-1/2 items-center gap-1 whitespace-nowrap rounded-full bg-[#2563EB] px-3 py-1 text-[10px] font-bold uppercase tracking-wide text-white shadow-sm">
                      <BadgeCheck size={12} />
